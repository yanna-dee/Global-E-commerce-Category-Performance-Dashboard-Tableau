...
- Monthly trend line chart for performance tracking
- Category-wise revenue breakdown (8 categories)
- Global map showing country-level sales distribution (6 countries)
- Interactive filtering by month

## Dataset
### Contains synthetic data including:
- Order Date
- Revenue
- Order Volume
- Product Categories
